...
#I choose to make a list for all available options that both the player and computer will use. 
...
#If the computer and player had a draw the word joust would appear and 1 point would be subtracted from the computer.
#growing up when ever my friends and I would play Rock, Paper, Scissors whenever there was a draw the first one to shout out the word "joust" would win the bout.
...
#The items are listed in the rock paper scissors format.
